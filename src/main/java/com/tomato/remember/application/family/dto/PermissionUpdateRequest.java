...
public class PermissionUpdateRequest {
     ...
     * 생성자
     */
    public PermissionUpdateRequest(Boolean memorialAccess, Boolean videoCallAccess) {
        this.memorialAccess = memorialAccess;
        this.videoCallAccess = videoCallAccess;
    }
     ...
     * 모든 권한 허용
     */
    public static PermissionUpdateRequest allowAll() {
        return new PermissionUpdateRequest(true, true);
    }

    /**
     * 모든 권한 차단
     */
    public static PermissionUpdateRequest denyAll() {
        return new PermissionUpdateRequest(false, false);
    }

    /**
     * 메모리얼 접근만 허용
     */
    public static PermissionUpdateRequest memorialOnly() {
        return new PermissionUpdateRequest(true, false);
    }
    ...
    public boolean isUpgrade(Boolean currentMemorialAccess, Boolean currentVideoCallAccess) {
        PermissionUpdateRequest current = new PermissionUpdateRequest(currentMemorialAccess, currentVideoCallAccess);
