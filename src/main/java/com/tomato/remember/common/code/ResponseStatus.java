...
public enum ResponseStatus {
  ...
  CANNOT_DELETE_MEMORIAL_WITH_FAMILY_MEMBERS("ER_2008", "가족 구성원이 있는 메모리얼은 삭제할 수 없습니다. 먼저 가족 구성원을 제거해주세요.", HttpStatus.BAD_REQUEST),
  ...
  MEMORIAL_ALREADY_DELETED("ER-2015", "이미 삭제된 메모리얼입니다.", HttpStatus.BAD_REQUEST),
